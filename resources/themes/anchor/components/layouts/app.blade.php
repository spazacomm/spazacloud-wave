...
<body x-data class="flex flex-col lg:min-h-screen bg-custom-white-dark dark:bg-zinc-900 @if(config('wave.dev_bar')){{ 'pb-10' }}@endif">
    ...
    <div class="flex flex-col min-h-screen pl-0 justify-stretch lg:pl-64">
        ...
        <main class="flex flex-col flex-1 xl:px-0 lg:pt-4 lg:h-screen">
            <div class="flex-1 h-full overflow-hidden bg-custom-white-dark  dark:bg-zinc-800 lg:rounded-tl-xl border-zinc-200/70 dark:border-zinc-700">
